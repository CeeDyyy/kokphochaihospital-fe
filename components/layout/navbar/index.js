    ...
    <>
      <nav className="z-50 fixed h-16 w-screen px-8 md:px-32 2xl:px-96 grid grid-cols-3 justify-items-center content-center lg:flex justify-evenly items-center bg-white">
        ...
        <div className="hidden lg:flex gap-x-2 items-center">
          ...
          <select className="h-fit py-1 px-2 hover:bg-gray-100 rounded-lg duration-150 cursor-pointer" onChange={(e) => router.push(pathname + '?' + createQueryString('lang', e.target.value))}>
      ...
      <Drawer
        ...
        className="grid content-between p-4"
      >
        <div className="grid gap-y-8">
          <div className="flex justify-between">
            <button onClick={() => router.push('/')} className="flex items-center gap-x-2 pointer">
              <img src="/images/KPC_LOGO.png" width={48} height={48} />
